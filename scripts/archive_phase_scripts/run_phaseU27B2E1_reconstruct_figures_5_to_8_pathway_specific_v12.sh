...
SCRIPT="$PROJECT_ROOT/10_scripts/phaseU27B2E1_reconstruct_figures_5_to_8_pathway_specific_v12.py"
TAG="phaseU27B2E1_pathway_specific_figures_5_to_8_reconstruction"
LOGDIR="$PROJECT_ROOT/08_logs/$TAG"

mkdir -p "$LOGDIR"
STAMP="$(date +%Y%m%d_%H%M%S)"
LOG="$LOGDIR/phaseU27B2E1_v12_run_${STAMP}.log"
...
echo
echo "Phase U27B2E1 v1.2 finished."
echo "Log: $LOG"
echo "Decision: $PROJECT_ROOT/06_tables/$TAG/UTI_HostOmics_U27B2E1_phase_decision.tsv"
echo "Axis mapping audit: $PROJECT_ROOT/06_tables/$TAG/UTI_HostOmics_U27B2E1_axis_mapping_validation.tsv"
